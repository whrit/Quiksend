...
CREATE INDEX "message_prospect_idx" ON "message" USING btree ("organization_id","prospect_id");--> statement-breakpoint
-- Minimal prospect stub for Track 4 isolated dev (Track 2 replaces with full schema on merge).
...
DO $$ BEGIN
 ALTER TABLE "message" ADD CONSTRAINT "message_prospect_id_prospect_id_fk" FOREIGN KEY ("prospect_id") REFERENCES "public"."prospect"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
